 ...
 */
public class HeadingProfiledPIDController {
    private static int instances;

    private HeadingPIDController m_controller;
     ...
     */
    public HeadingProfiledPIDController(
    ...
    public HeadingProfiledPIDController(
        ...
        m_controller = new HeadingPIDController(Kp, Ki, Kd, period);
